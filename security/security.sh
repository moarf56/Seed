...
wget http://www.jrabbit.org/scripts/JRabbitBox/tools/backup-manager-post
cp backup-manager-post ~/JRabbitBox/tools/
mv backup-manager-post /etc/backup-manager-post
